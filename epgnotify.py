...
def setup_parser():
    ...
    parser=argparse.ArgumentParser(prog='Epgnotify',
    ...
    parser.add_argument('--cache-file', type=str, metavar='file',
            help="Optionally, cache file location, default epgnotfiy.cache.yaml in home directory is used")

    parser.add_argument('--epg-dst-file', type=str, default=None,
...
def programlist_to_html(program_list, link_base=None):
    ...
    for p in program_list:
        ...
        s+='<br><a href="{}/vdradmin.pl?aktion=timer_new_form&epg_id={}&channel_id={}&referer={}">Link to vdradmin-am</a>'.format(
                ...
                int(eid),
                cid,
                'Li92ZHJhZG1pbi5wbD9ha3Rpb249dGltZXJfbGlzdA=='
                   )
